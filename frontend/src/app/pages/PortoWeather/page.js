...
export default function PortoWeatherPage() {
  ...
  const chartOption = useMemo(() => {
    if (!dbPortoWeather || !dbPortoWeather.forecast) {
      return {};
    }
    ...
    const forecastData = dbPortoWeather.forecast;
    ...
    return {
      ...
      title: {
        text: `Weather Forecast - ${dbPortoWeather.location?.city || "Porto"}, ${dbPortoWeather.location?.country || "Portugal"}`,
        left: "center",
        textStyle: {
  ...
  }, [dbPortoWeather, darkMode, mobileDevice]);
